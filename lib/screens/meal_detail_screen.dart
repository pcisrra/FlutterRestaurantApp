...
class _MealDetailScreenState extends State<MealDetailScreen> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      if (catogoryId != null) {
        currentCatogory = Provider.of<CategoriesList>(context)
            .catogoriesList
                ...
                onPressed: () async {
                  ...
                  try {
                    ...
                    _scaffoldKey.currentState.showSnackBar(SnackBar(
                      ...
                      content: Text('Tu orden se concretó!!'),
                    ...
                    _scaffoldKey.currentState.showSnackBar(SnackBar(
                      backgroundColor: Colors.black54,
                      content: Text('No se puede ordenar ahora, intentalo más tarde!'),
                      duration: Duration(seconds: 1),
                    ));
                  }
                },
            ...
            FloatingActionButton(
              ...
              onPressed: () {
                ...
                _scaffoldKey.currentState.showSnackBar(
                  SnackBar(
                    backgroundColor: Colors.black54,
                    content: Text('Agregar comida al carrito!'),
                    duration: Duration(seconds: 1),
